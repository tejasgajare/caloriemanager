...
class FoodActivity : AppCompatActivity(), FoodAdapter.ItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        foods.add(FoodItem("Chicken Sandwich", "1 slice", 210, 23, 34, 23))
        foods.add(FoodItem("Veggie Sandwich", "1 slice", 210, 23, 34, 23))
        foods.add(FoodItem("Chicken Burger", "1 slice", 210, 23, 34, 23))
        foods.add(FoodItem("Veggie Burger", "1 slice", 210, 23, 34, 23))
        foods.add(FoodItem("Aloo Tikki Burger", "1 slice", 210, 23, 34, 23))
        foods.add(FoodItem("Tuna Salad", "1 bowl", 176, 45, 23, 23))
        foods.add(FoodItem("Veggie Salad", "1 bowl", 176, 45, 23, 23))
        foods.add(FoodItem("Caesar Salad", "1 bowl", 176, 45, 23, 23))
        foods.add(FoodItem("Honey Oats", "20 Grams", 83, 34, 56, 23))
        foods.add(FoodItem("Mango Smoothie", "20 Grams", 83, 34, 56, 23))
        foods.add(FoodItem("Pancakes", "20 Grams", 83, 34, 56, 23))
        foods.add(FoodItem("Chicken Tacos", "20 Grams", 83, 34, 56, 23))
        foods.add(FoodItem("Veggie Tacos", "20 Grams", 83, 34, 56, 23))
